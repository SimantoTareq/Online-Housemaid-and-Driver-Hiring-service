...
?>
  ...
  <body>
    ...
    <a class="btn btn-outline-info" href="usermassage.php" role="button" style="margin-top: 20px; margin-bottom: 20px; margin-left: 50%;">Conversation with Admin</a>



    <?php require_once 'usermessagetoadmin.php'; ?>
    <div class="container justify-content-center">
      <form action="usermessagetoadmin.php" method="POST">


        <div class="form-group" style="padding: 20px 0px; width:50%;">
    ...
    <div class="massage" style=" width:500px; align-content: center;">
      ...
      ?>
      <a href="user.php" class="btn btn-warning btn-lg active" role="button" aria-pressed="true" style="margin:20px 20px;">Go Back</a>
    </div>
