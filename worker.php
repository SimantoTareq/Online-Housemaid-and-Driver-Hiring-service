...
?>
  ...
  <body>
    ...
    <div class="container" style="padding: 100px;">
      ...
      <a class="btn btn-outline-info" href="user.php">Worker</a>
      <h1 style="margin-top: 20px; margin-bottom: 50px; ">Welcome <?php echo $workerid ?></h1>



      <div class="btn-group" role="group" aria-label="Basic example">
        <a href="drivingjobs.php" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true" style="margin-right:10px;">Look For Drivering Jobs</a>
        <a href="maidjobs.php" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true" style="margin-right:10px;">Look For Maid Jobs</a>
      </div>
