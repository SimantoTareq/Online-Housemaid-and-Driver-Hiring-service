...
<body>
  ...
  <a class="btn btn-outline-info" href="usermessage.php" role="button" style="margin-top: 20px; margin-bottom: 20px; margin-left: 50%;">Send Massage to User</a>
  ...
  <div class="massage" style=" width:500px; align-content: center;">
    <div class="blockquote text-center">Massages:</div>
    ...
    ?>
        <div class="leftmassage" style="text-align:center;color:red; border:20px">
    ...
    ?>
    <a href="admin.php" class="btn btn-warning btn-lg active" role="button" aria-pressed="true" style="margin:20px 20px;">Go Back</a>
  </div>
