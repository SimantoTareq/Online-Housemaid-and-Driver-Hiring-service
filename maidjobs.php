...
?>
  ...
  <body>
    ...
    <div class="container">
      <a class="btn btn-outline-info" href="maidjobs.php" role="button" style="margin:20px 0px;">Maid Job List</a>
      <?php
      ...
      <div class="rpw justify-content-center">
        ...
        <a href="worker.php" class="btn btn-dark btn-lg active" role="button" aria-pressed="true" style="margin:20px 0px;">Go Back</a>
      </div>
    </div>
    <?php
