...
?>
  ...
  <body>
    ...
    <!-- End Header -->
    <div class="container">
      <a class="btn btn-outline-info" href="lookingfordrivers.php" role="button" style="margin-top: 20px; margin-bottom: 20px; margin-left: 50%;">Drivers List</a>
    </div>
    ...
    <div class="container">
      ...
      <div class="rpw justify-content-center">
              ...
              <tr>
                <form action="" method="POST" role="form">
                  ...
                  <td>
                    ...
                    <button type="submit" class="btn btn-info" role="button" style="margin-top:10px" name="reviewbtn" value="<?php echo $row['workerid']; ?>">See Review</button>
                  </td>
                  <td>

                    <button type="submit" class="btn btn-success" role="button" style="margin-top:10px" name="hirebtn" value="<?php echo $row['workerid']; ?>">Hire</button>
        ...
        <a href="user.php" class="btn btn-dark btn-lg active" role="button" aria-pressed="true" style="margin:20px 0px;">Go Back</a>
      </div>
    </div>
    <?php
