              ...
              <tr>
                <form action="" method="POST" role="form">
                  ...
                  <td>
                    ...
                    <button type="submit" class="btn btn-info" role="button" name="reviewbtn" style="margin-top:10px" value="<?php echo $row['workerid']; ?>">See Review</button>
                  </td>
                  <td>

                    <button type="submit" class="btn btn-success" role="button" name="hirebtn" style="margin-top:10px" value="<?php echo $row['workerid']; ?>">Hire</button>
