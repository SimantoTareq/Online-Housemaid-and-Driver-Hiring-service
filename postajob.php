...
?>
  ...
  <body>
    ...
    <div class="container" style="padding: 50px; justify-content: center;">
      <a class="btn btn-outline-info" href="postajob.php" role="button" style="margin-top: 20px; margin-bottom: 20px; margin-left: 46%;">Job Post</a>



      <?php require_once 'processpostajob.php'; ?>
      <div class="card" style="width: 370px; padding:10px ;margin:auto">
        <form action="processpostajob.php" method="POST" style="max-width: 350px;">
    ...
    ?>
    <a href="user.php" class="btn btn-dark btn-lg active" role="button" aria-pressed="true" style="margin:20px;">Go Back</a>
